...
export class SettingsTab extends PluginSettingTab {
	...
	private addUpdateContacts() {
		new Setting(this.containerEl)
			...
			.setDesc(
				'Update contacts when they are changed in Contacts.app. Can lose the obsidian data',
			)
			.addToggle((toggle) => {
		...
		new Setting(this.containerEl)
			...
			.addExtraButton((button) => {
				button
					...
					.setTooltip('Reset to default')
					.onClick(async () => {
						this.plugin.settings.propertiesTemplate =
							DEFAULT_SETTINGS.propertiesTemplate;
						await this.plugin.saveSettings();
						this.display();
